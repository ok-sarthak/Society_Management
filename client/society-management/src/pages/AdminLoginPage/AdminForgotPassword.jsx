...
const AdminForgotPassword = () => {
  ...
  const handleReset = (e) => {
    e.preventDefault();
    setMessage('If this admin email is registered, a password reset link has been sent.');
  };
  ...
  return (
    <div className="min-h-screen w-full flex flex-col justify-center items-center bg-gradient-to-br from-gray-900 to-gray-800">
      <div className="bg-gray-800/90 backdrop-blur-sm border border-gray-700 p-8 sm:p-12 rounded-2xl shadow-2xl max-w-sm sm:max-w-md w-full mx-4 flex flex-col items-center">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-white text-center">Reset Admin Password</h2>
        ...
        <form onSubmit={handleReset} className="w-full">
          <input
            ...
            required
            className="w-full text-base sm:text-lg p-3 sm:p-4 mb-6 rounded-lg border border-gray-600 bg-gray-700/50 text-white placeholder-gray-400 focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-400/50 transition-all duration-200"
          />
